...
private void tb3()
    {
        String sql ="select * from purchase_dep";
        try
        {
...
private void combo()
{
    ...
    private void initComponents() {
        ...
        setTitle("Purchase Department");

        jPanel1.setBackground(new java.awt.Color(204, 255, 0));
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 1, true), "Purchase_Report", javax.swing.border.TitledBorder.LEFT, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Script MT Bold", 1, 30), new java.awt.Color(0, 102, 255))); // NOI18N
        ...
        choice.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Select" }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        String sql="select * from purchase_dep where dep_name='"+choice.getSelectedItem().toString()+"'";
        try{
            pst=conn.prepareStatement(sql);
             rs=pst.executeQuery();
            table.setModel(DbUtils.resultSetToTableModel(rs));
